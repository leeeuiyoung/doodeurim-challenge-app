...
const declarations = [
    "나는 영적 나실인입니다!", "나는 하나님이 기뻐하시고 사랑하시는 자녀입니다!", "예수님의 온유와 겸손이 내 안에 있습니다!", "나는 하나님의 지혜로 충만합니다!", "유혹과 시험을 이겨낼 힘이 내 안에 있습니다!", "주님은 원수의 목전에서도 상을 베풀어 주십니다!", "나는 하나님 보시기에 심히 좋은 존재입니다!", "나는 하나님의 큰 그림을 믿습니다!", "세상을 이기신 주님이 내 안에 계십니다!", "나는 새사람의 정체성으로 살아갑니다!", "하나님은 든든한 내 아버지이십니다!", "나는 복된 자리에만 거하겠습니다!", "나의 우선순위는 말씀과 기도입니다!", "나는 하나님께 칭찬받는 자녀입니다!", "급진적인 겸손이 내안에 있습니다!", "나는 약함속에서도 다시 일어섭니다!", "주님은 가장 좋은 것으로 채워주십니다!", "나는 하늘나라의 상속자입니다!", "주님은 우리 가정을 부요케 하십니다!", "나는 이미 천국열쇠를 가졌습니다!", "나는 주와 한영입니다!", "나는 어둠을 몰아내는 빛입니다", "실패해도 주님을 여전히 나를 사랑하십니다!", "나는 빛 가운데 걸어가는 자녀입니다!", "내 삶의 구석마다 주님의 손길이 머물고 있습니다!", "나는 선한 영향력을 나타내는 소금입니다!", "나는 빛의 갑옷을 입었습니다!", "예수님의 권세가 나의 권세입니다!", "나는 풍성한 결실을 맺는 좋은 땅입니다!", "나는 축복의 유통자입니다!", "나는 그리스도의 향기입니다!"
];
const prayerTopics = ["담임목사님의 사역과 건강을 위해", "부목사님과 청장년 리더들을 위해", "캄보디아 단기선교를 위해", "특새를 통해 큰 은혜 받기 위해", "자녀들이 영육간에 잘 성장하기 위해"];
